...
ms.custom:
description: "Windows and Mac documentation for supported Microsoft Edge Browser policy: Disable third-party storage partitioning for specific top-level origins (deprecated)"
---
...
## Disable third-party storage partitioning for specific top-level origins (deprecated)
...
- GP name: Disable third-party storage partitioning for specific top-level origins (deprecated)
