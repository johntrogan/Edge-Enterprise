...
ms.custom:
description: "Windows and Mac documentation for supported Microsoft Edge Browser policy: Specifies whether to block requests from public websites to devices on a user&#x27;s local network. (Deprecated)"
---
...
If you enable this policy, Microsoft Edge blocks any request that would otherwise trigger a DevTools warning
