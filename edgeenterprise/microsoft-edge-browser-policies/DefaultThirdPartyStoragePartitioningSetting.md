...
ms.custom:
description: "Windows and Mac documentation for supported Microsoft Edge Browser policy: Default setting for third-party storage partitioning (deprecated)"
---
...
## Default setting for third-party storage partitioning (deprecated)
...
- GP name: Default setting for third-party storage partitioning (deprecated)
