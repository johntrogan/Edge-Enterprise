...
ms.custom:
description: "Windows and Mac documentation for supported Microsoft Edge Browser policy: Specifies whether to apply restrictions to requests to more private network endpoints (obsolete)"
---
