...
| **sidebar_auto_open_blocked**   |  Available from Microsoft Edge 119<br>If this field is set to `true`, any sidebar app with the specified extension ID will be prevented from automatically opening.   |
