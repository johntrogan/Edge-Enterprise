...
- **Microsoft Search experience in the Microsoft Edge address bar.**  After March 31, 2025, the Microsoft Edge for Business address bar sends users to work results on Microsoft 365.cloud.microsoft rather than Bing.com. Users of the address bar can continue to find work-related documents, bookmarks, and people in suggested results—clicking on these suggestions takes users to work results on Microsoft 365.cloud.microsoft. Users can also type "work" in the address bar, hit the tab key, then type in their work-related query to get work results on a Microsoft 365.cloud.microsoft page. Work search results continue to include documents, people, and bookmarks.  For more information, see [Guidance for retiring Microsoft Search in Bing for your organization](/microsoftsearch/retirement-microsoft-search-bing).  **Note:** Microsoft Edge version 134.0.3134.51+ is required
