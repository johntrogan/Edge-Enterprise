...
| --- | --- | --- | --- |
| 137 | 	Starting in Microsoft Edge Stable version 137.0.3296.52, customers may encounter unexpected leading spaces in the browser window title, which can break automation workflow for non-English language environments.  |  | We're working to release a fix for Microsoft Edge. |
