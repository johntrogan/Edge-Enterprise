...
| --- | --- | --- | --- |
| 135 | Customers may see an issue where the first-run experience (FRE) page edge://welcome-new-device opens and fails with an error message page that doesn't close. This occurs when FRE is disabled and might be triggered suddenly after upgrade.  | Roll back Microsoft Edge to version 134.0.3124.95 or modify the HideFirstRunExperience policy to “0”. | This is a known-issue, and it is being currently worked on by the Microsoft Edge team. |
