...
| 136 | 	On the Microsoft Edge New Tab Page (NTP), customers may see differing feeds.  Even when NTP policies are configured, users may have the Discover or My Feed selected.  |  | We're working to release a fix for Microsoft Edge. |
