...
| 136 | 	For users with the 'Auto hidden' sidebar visibility setting, their Outlook or Teams link may not be showing the sidepane content as expected. | | We're working to release a fix for Microsoft Edge. |
