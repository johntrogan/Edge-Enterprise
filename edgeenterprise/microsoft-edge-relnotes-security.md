...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 139.0.3405.86)** which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).  
...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 138.0.3351.109)** which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide). 

## July 16, 2025

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 138.0.3351.95)** which incorporates the latest Security Updates of the Chromium project. This update contains a fix for [CVE-2025-6558](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-6558) which has been reported by the Chromium team as having an exploit in the wild. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).


## July 1, 2025

Microsoft has released the **latest Microsoft Edge Stable Channel (Version 138.0.3351.65)**, which incorporates the latest Security Updates of the Chromium project. This update contains a fix for [CVE-2025-6554](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-6554) which has been reported by the Chromium team as having an exploit in the wild. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide). 

This update contains the following Microsoft Edge specific security fixes:

- [CVE-2025-49713](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-49713)

## June 26, 2025

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 138.0.3351.55)** which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

This update contains the following Microsoft Edge specific security fixes:

- [CVE-2025-47963](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-47963)
...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 137.0.3296.83)** which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

## June 4, 2025

Microsoft has released the latest **Microsoft Edge Extended Stable Channel (Version 136.0.3240.115)** which incorporates the latest Security Updates of the Chromium project. This update contains a fix for [CVE-2025-5419](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-5419) which has been reported by the Chromium team as having an exploit in the wild. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
...
Microsoft has released the latest **Edge Update (Version 1.3.195.61)**, For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

This release contains the following Microsoft Edge Update specific security fix:

- [CVE-2025-47181](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-47181)

## May 15, 2025

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 136.0.3240.76)**, which incorporates the latest Security Updates of the Chromium project. This update contains a fix for [CVE-2025-4664](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-4664) which has been reported by the Chromium team as having an exploit in the wild. For more information, see the [Security Update Guide.](https://msrc.microsoft.com/update-guide).

## May 8, 2025

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 136.0.3240.64)**, which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide). 

## May 1, 2025

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 136.0.3240.50)**, which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

This update contains the following Microsoft Edge specific security fixes:

- [CVE-2025-29825](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-29825)

## April 24, 2025

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 135.0.3179.98)**, which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide). 

## April 17, 2025 

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 135.0.3179.85)**, and **Microsoft Edge Extended Stable Channel (Version 134.0.3124.129)** which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

## April 11, 2025

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 135.0.3179.73)**, which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

This update contains the following Microsoft Edge specific security fixes:

- [CVE-2025-29834](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-29834)
...
Microsoft has released the **latest Microsoft Edge Stable Channel (Version 134.0.3124.93)**, which incorporates the latest Security Updates of the Chromium project. This update contains a fix for [CVE-2025-2783](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-2783) which has been reported by the Chromium team as having an exploit in the wild. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide). 
...
Microsoft has released the **latest Microsoft Edge Stable Channel (Version 134.0.3124.62)**, which incorporates the latest Security Updates of the Chromium project. This update contains a fix for [CVE-2025-24201](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-24201) which has been reported by the Chromium team as having an exploit in the wild.  
For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide)

## March 6, 2025

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 134.0.3124.51)**, which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 133.0.3065.92 And Extended Stable Channel Version 132.0.2957.178)**, which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

## February 21, 2025

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 133.0.3065.82)**, which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

## February 20, 2025

Microsoft has released the latest **Microsoft Edge Extended Stable Channel (Version 132.0.2957.171)**, which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

This update contains the following Microsoft Edge specific security fixes:

- [CVE-2025-21279](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-21279)
...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 133.0.3065.69)**, which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 133.0.3065.51)** which incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 132.0.2957.140)** which incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

## January 24, 2025

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 132.0.2957.127)** which incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 132.0.2957.115)** which incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
...
Microsoft has released the latest **Microsoft  Edge Stable Channel (Version 131.0.2903.146 and Version 131.0.2903.147)** that incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

## December 19, 2024

Microsoft has released the latest **Microsoft  Edge Stable Channel (Version 131.0.2903.112) And Extended Stable Channel (Version 130.0.2849.123)** that incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

## December 12, 2024

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 131.0.2903.99) And Extended Stable Channel (Version 130.0.2849.116)** that incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).


## December 5, 2024

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 131.0.2903.86)** which incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 131.0.2903.63)** which incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

This update contains the following Microsoft Edge-specific update:

- [CVE-2024-49054](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-49054)

## November 14, 2024

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 131.0.2903.48)** which incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

This update contains the following Microsoft Edge-specific update:

- [CVE-2024-49025](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-49025)

## November 7, 2024

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 130.0.2849.80)** that incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

## October 31, 2024

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 130.0.2849.68)** that incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).

## October 24, 2024

Microsoft has released the latest **Microsoft Edge Stable Channel (Version 130.0.2849.56)** that incorporates the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 129.0.2792.79) and Microsoft Edge Extended Stable Channel (128.0.2739.107)** which incorporate the latest updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
...
Microsoft has a fix for [CVE-2023-7024](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2023-7024) to **Microsoft Edge Stable Channel (Version 120.0.2210.91)**, which has been reported by the Chromium team as having an exploit in the wild. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 111.0.1661.41)** which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide).
...
Microsoft has released the latest **Microsoft Edge Stable Channel (Version 94.0.992.47)**, which incorporates the latest Security Updates of the Chromium project. For more information, see the [Security Update Guide](https://msrc.microsoft.com/update-guide)
